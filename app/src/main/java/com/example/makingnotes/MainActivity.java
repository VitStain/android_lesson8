...
public class MainActivity extends AppCompatActivity implements MenuItem.OnMenuItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fragmentTransaction.replace(R.id.list_of_notes_fragment_container, new ListOfNoteBlankFragment());
    ...
    private boolean navigateMenu(int id) {
        switch (id) {
            case R.id.nav_main:
                Toast.makeText(this, getResources().getString(R.string.n_main), Toast.LENGTH_LONG).show();
                return true;
